...
<div id="wrapper">
      ...
      <li>
        <article class="post">
          ...
          <a href="<?php print url($slide1_url); ?>">
            ...
            <?php else: ?>
              <img src="<?php print base_path() . drupal_get_path('theme', 'ict4d_theme') . '/images/slide-image-1.jpg'; ?>" class="slide-image" alt="<?php print $slide_alt; ?>" /></a>
            <?php endif; ?>
          <div class="clear"></div>
        </article>
      </li>
      ...
      <li>
        <article class="post">
          ...
          <a href="<?php print url($slide2_url); ?>">
            ...
            <?php else: ?>
              <img src="<?php print base_path() . drupal_get_path('theme', 'ict4d_theme') . '/images/slide-image-2.jpg'; ?>" class="slide-image" alt="<?php print $slide2_alt; ?>" /></a>
            <?php endif; ?>
          <div class="clear"></div>
        </article>
      </li>
      ...
      <li>
        <article class="post">
          ...
          <a href="<?php print url($slide3_url); ?>">
            ...
            <?php else: ?>
              <img src="<?php print base_path() . drupal_get_path('theme', 'ict4d_theme') . '/images/slide-image-3.jpg'; ?>" class="slide-image" alt="<?php print $slide3_alt; ?>" /></a>
            <?php endif; ?>
          <div class="clear"></div>
        </article>
      </li>
  ...
  <div id="footer">
    ...
    <?php if (!theme_get_setting('remove_copyright')): ?>
	 ...
	 <center>
       <p class="copyright"><?php print t('Copyright '); ?> &copy; <?php echo date("Y"); ?>,Bahir Dar University <?php print check_plain(theme_get_setting('copyright_holder')) ?></p>
	   </center>
     <?php else: ?>
